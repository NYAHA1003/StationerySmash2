...
namespace Battle.Units
{
	...
	public class GreenCarMoveState : IgnoreMoveState
	{
		...
		{
			AtkData atkData = new AtkData(_myUnit, _myUnit.UnitStat.Return_Attack(), _myUnit.UnitStat.Return_Knockback(), 0, _myUnitData._dir, _myUnit.ETeam == TeamType.MyTeam, 0, EffAttackType.Normal, EffectType.Attack, originValue);
