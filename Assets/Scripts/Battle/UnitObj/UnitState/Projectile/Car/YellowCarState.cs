...
namespace Battle.Units
{
	...
	public class YellowCarMoveState : IgnoreMoveState
	{
		...
		{
			AtkData atkData = new AtkData(_myUnit, _myUnit.UnitStat.Return_Attack(), _myUnit.UnitStat.Return_Knockback(), 0, _myUnitData._dir, _myUnit.ETeam == TeamType.MyTeam, 0, EffAttackType.SlowDown, EffectType.Attack, 1, 20, 20);
