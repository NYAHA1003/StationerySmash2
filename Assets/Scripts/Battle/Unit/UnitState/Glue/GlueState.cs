...
public class GlueAttackState : AbstractAttackState
{
    ...
    {
        atkData = new AtkData(_myUnit, _myUnit.UnitStat.Return_Attack(), _myUnit.UnitStat.Return_Knockback(), 0, _myUnitData.dir, _myUnit.ETeam == TeamType.MyTeam, 0, AtkType.SlowDown, _myUnit.SkinData._effectType, originValue);
    }
}
