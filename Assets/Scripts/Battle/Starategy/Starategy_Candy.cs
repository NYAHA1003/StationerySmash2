...
namespace Battle.Starategy
{
	...
	public class Starategy_Candy : AbstractStarategy
	{
		public override void Run_Card(TeamType eTeam)
		{
			...
			{
				Check_Range(_battleManager.UnitComponent._enemyUnitList, true, _starategyData._starategyablityData);
			}
			else if (eTeam == TeamType.EnemyTeam)
			{
				Check_Range(_battleManager.UnitComponent._playerUnitList, false, _starategyData._starategyablityData);
			}
		}
