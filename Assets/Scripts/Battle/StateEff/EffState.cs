...
public abstract class EffState
{
    ...
    public AtkType StatusType => _statusType; //유닛 상태타입
    ...
    private AtkType _statusType = AtkType.Normal; //어택타입, 이펙트타입
    ...
    public void SetEffType(AtkType atkType, params float[] value)
    {
        _statusType = atkType;
        _valueList = value;
    }
