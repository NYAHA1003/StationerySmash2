...
{
    const string langURL = "https://docs.google.com/spreadsheets/d/19NVshReriTZsf36cCWqUvFX6bhaWSGoDOb--1XZ0IVo/export?format=tsv&gid=2132424280"; //언어 데이터가 담겨진 구글 스프레드 시트의 링크
